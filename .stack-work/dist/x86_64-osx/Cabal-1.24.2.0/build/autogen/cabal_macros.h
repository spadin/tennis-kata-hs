...
/* package tennis-kata-hs-0.1.0.0 */
#define VERSION_tennis_kata_hs "0.1.0.0"
#define MIN_VERSION_tennis_kata_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "tennis-kata-hs-0.1.0.0-7LYADaKW0xO4B0QIeBOVsZ"

#define CURRENT_PACKAGE_KEY "tennis-kata-hs-0.1.0.0-7LYADaKW0xO4B0QIeBOVsZ"
